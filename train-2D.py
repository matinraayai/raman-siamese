import torch
import tqdm
from dataset import DeepCidDataset2
...
def main():
    ...
    train_data = DeepCidDataset2(args.data_path, args.train_data_fold)
    valid_data = DeepCidDataset2(args.data_path, args.train_data_fold, train=False)
